...
pub fn random_in_unit_sphere(mut rng: SmallRng) -> Vec3 {
...
pub fn random_unit_vector(mut rng: SmallRng) -> Vec3 {
...
/// Internal helper.
pub fn random_cosine_direction(mut rng: SmallRng) -> Vec3 {
...
/// Internal helper.
pub fn random_to_sphere(radius: Float, distance_squared: Float, mut rng: SmallRng) -> Vec3 {
    let r1 = rng.gen::<Float>();
    let r2 = rng.gen::<Float>();
