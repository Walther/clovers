...
/// [MovingSphereInit] structure describes the necessary data for constructing a [MovingSphere]. Used with [serde] when importing [SceneFiles](crate::scenes::SceneFile).
